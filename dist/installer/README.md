...
O catálogo oficial começa em `0.1.0`. A baseline-fonte no Git é `1.0.16`
(`packages/latest`). A `1.0.15`, a `1.0.14`, a `1.0.13`, a `1.0.12`, a `1.0.11`, a `1.0.10`, a `1.0.9`, a `1.0.8`, a `1.0.7`, a `1.0.6`, a `1.0.5`, a `1.0.4`, a `1.0.3`, a `1.0.2`, a `0.7.13` e a release GitHub `1.0.0` owner-only
