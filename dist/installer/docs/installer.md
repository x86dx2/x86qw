...
O bundle da árvore-fonte é a baseline `1.0.10`, com o catálogo current apontando
para esse instalador e 21 componentes registrados. A `1.0.9`, a `1.0.8`, a `1.0.7`, a `1.0.6`, a `1.0.5`, a `1.0.4`, a `1.0.3`, a `1.0.2`, a `1.0.1`, a `0.7.13` e a `1.0.0`
