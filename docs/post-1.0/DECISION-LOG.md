...
| D-03 | main verde é pré-condição; Gate 0A está fechado | decidido | Validate 33116886265, SHA 9ec18b6…, 5/5 jobs exigidos |
...
| D-15 | source release-truth foi mesclada; deployment live converge no candidato | concluído | receipt 33115777739; root 200 owner-only; TUF público v28/v27 |
| D-16 | Gate 0A passou; Gate 0B continua external-only; 0C owner-only convergiu | decidido | main verde; receipt 33115777739; monitor TUF saudável |
...
| D-19 | fonte e deployment não podem responder versões/audiência incompatíveis | resolvido | product/catalog/site/release-truth convergentes; receipt 33115777739 |
