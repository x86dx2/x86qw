...
| G-002 | P1 | projeção live ainda precisa confirmar árvore assembled | RESOLVED | receipt 33136179763; root 200 owner-only | owner-only | manter convergência após cada overlay |
...
| G-008 | P0_OPERATIONAL | lease TUF precisa continuar renovável | HEALTHY_WITH_OPERATION | timestamp v30 autenticado e monitor técnico saudável | owner-only | manter alerta e renovar antes da janela |
...
| G-016 | P1 | source/projection live não confirmada no novo caminho assembled | RESOLVED | owner-only projection repair; receipt 33136179763 artifact 9672118367 | owner-only | overlay seguinte deve preservar TUF v30/v29 e os contexts verdes |

## Ordem de tratamento

1. G-001 já está resolvido.
2. G-002 e G-016 fecharam a convergência da projeção owner-only no receipt 33136179763.
