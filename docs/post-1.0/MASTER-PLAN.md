...
- `source`: baseline current `1.0.4`; `1.0.3`, `1.0.2` e `0.7.13` permanecem históricas no catálogo.
...
- concluir e registrar a correção da projeção live (PASS, receipt 33115777739,
  artifact 9664449974);
...
A fonte current é **1.0.4**; `1.0.3`, `1.0.2`, `1.0.1` e `0.7.13` estão históricas. F1–F3 e o
