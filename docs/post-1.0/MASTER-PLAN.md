...
- `source`: baseline current `1.0.5`; `1.0.4`, `1.0.3`, `1.0.2` e `0.7.13` permanecem históricas no catálogo.
...
A fonte current é **1.0.5**; `1.0.4`, `1.0.3`, `1.0.2`, `1.0.1` e `0.7.13` estão históricas. F1–F3 e o
