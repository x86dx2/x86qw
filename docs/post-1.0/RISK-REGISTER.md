...
| R-002 | autoridade comunica bytes ou audiência errados | média | crítica | high | CONTROLLED | owner-only | projeção única, hashes e verificação live; receipt 33125534974 |
