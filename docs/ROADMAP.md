...
| Downloads remotos | completa no código corretivo da issue #45; em revisão e ainda não publicada | 565 testes de manutenção e cinco do site aprovados localmente; oito skips explícitos (sete Windows e um smoke de rede); matriz do PR concluída em Ubuntu, macOS e Windows com Python 3.10 e 3.13 |
