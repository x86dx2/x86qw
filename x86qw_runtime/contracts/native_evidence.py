...
# This is the release gate's complete platform set.  macOS-X64 remains a
# known/conditionally supported platform, but it cannot silently substitute
# for the required arm64 client evidence and is therefore not part of the
# promotion contract until a native Intel smoke is explicitly announced.
REQUIRED_NATIVE_PLATFORMS = frozenset({
    "Linux-X64",
    "macOS-ARM64",
    "Windows-X64",
})
...
CASE_ASSERTIONS = {
    "install-clean-space-unicode": frozenset({"installed", "path-space-unicode"}),
