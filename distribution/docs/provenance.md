...
| 17 componentes de referência nQuake | [distfiles](https://github.com/nQuake/distfiles) fixado por commit e decomposto por `distribution/inventory/components.json` | originais em `dist/nquake`; pacotes de entrega são builds reproduzíveis temporários |
