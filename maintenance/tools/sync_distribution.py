...
def verify_distribution(
    ...
    *,
    ...
    allowed_unmanaged = {
        ...
        "installer/assets/x86qw.svg",
        "installer/assets/x86qw.ico",
        "installer/assets/x86qw.icns",
        "installer/assets/x86qw-16.png",
        "installer/assets/x86qw-32.png",
        "installer/assets/x86qw-48.png",
        "installer/assets/x86qw-64.png",
        "installer/assets/x86qw-128.png",
        "installer/assets/x86qw-256.png",
        "installer/assets/x86qw-512.png",
