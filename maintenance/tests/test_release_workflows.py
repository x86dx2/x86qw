...
class ReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_patch_mirror_publication_is_protected_and_fail_closed(self):
        ...
        self.assertIn("-c lfs.fetchrecentrefsdays=0", source)
        self.assertIn('lfs fetch --include="$lfs_path" --exclude=\'\' origin', source)
        self.assertNotIn("git lfs fetch --object-id", source)
