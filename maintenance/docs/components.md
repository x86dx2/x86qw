...
| KTX | `1.47+x86qw.7` | release oficial sobre recursos nQuake e gameplay x86QW | mapa competitivo de teclas e abertura nQuake aplicados somente ao iniciar KTX, ajuda F10 colorida e multilinha, símbolos QVM preservados, carregamento QVM direto, nove modos locais declarativos e confirmação explícita do preset |
