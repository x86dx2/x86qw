...
| KTX | `1.47+x86qw.9` | release oficial sobre recursos nQuake e gameplay x86QW | mapa competitivo de teclas e abertura nQuake aplicados somente ao iniciar KTX, ajuda F10 colorida, alinhada e específica por modo, símbolos QVM preservados, carregamento QVM direto e nove modos locais declarativos |
