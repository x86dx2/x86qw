...
class SiteTests(unittest.TestCase):
    ...
    def test_public_bootstrap_matches_the_registered_installer_bundle(self):
        ...
        package = current[0]
        self.assertEqual("x86QW Installer 0.1.20", package["release_title"])
        self.assertIn(
            "github.com/x86dx2/x86qw/releases/download/x86qw-installer-0.1.20/",
            package["urls"][0],
        )
        self.assertEqual(
            [
                "0.1.0", "0.1.1", "0.1.2", "0.1.3", "0.1.4", "0.1.5",
                "0.1.6", "0.1.7", "0.1.8", "0.1.9", "0.1.10", "0.1.11", "0.1.12", "0.1.13", "0.1.14", "0.1.15", "0.1.19", "0.1.20",
            ],
