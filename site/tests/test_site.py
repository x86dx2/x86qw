...
class SiteTests(unittest.TestCase):
    ...
    def test_accessibility_and_catalog_contract_remain_explicit(self):
        ...
        self.assertIn("/api/v1/product.json", script)
        self.assertNotIn("fetch('/api/v1/catalog.json'", script)
        self.assertIn("product.project !== 'x86qw'", script)
        self.assertNotIn("item.component !== 'installer'", script)
