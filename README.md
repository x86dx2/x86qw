...
`1.0.8`; a `1.0.7`, a `1.0.6`, a `1.0.5`, a `1.0.4`, a `1.0.3`, a `1.0.2`, a `1.0.1`, a `0.7.13` e a release `1.0.0` owner-only permanecem históricas.
...
posterior. A baseline-fonte current é a `1.0.8`; o RC público e a `0.7.13`
...
A fonte current é `1.0.8` owner-only: um usuário, válida no Apple M3.
